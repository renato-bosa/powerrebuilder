...
def test_default_variable_node_creation():
    ...
    node = PBDefaultVariableNode(default_variable="my_var", start_position=10, stop_position=20)
...
def test_default_variable_node_equality():
    ...
    node1 = PBDefaultVariableNode(default_variable="var1", start_position=1, stop_position=2)
    node2 = PBDefaultVariableNode(default_variable="var1", start_position=1, stop_position=2)
    node3 = PBDefaultVariableNode(default_variable="var2", start_position=1, stop_position=2)
