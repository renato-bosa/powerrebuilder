"""Tests for the core PowerBuilder grammar.

This module contains tests for parsing the basic subset of PowerBuilder statements.
"""
...
var_declaration: IDENTIFIER ":" type_name ";"
