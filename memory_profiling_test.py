        ...
        try:
            ...
            for i in range(100):  # Create many objects to test memory usage
                ...
                mock_ast = {
                    ...
                    "parameters": [{"name": f"param_{j}", "type": "string"} for j in range(10)],
                    "body": {"statements": [{"type": "assignment", "value": f"value_{k}"} for k in range(20)]}
                }
        ...
        try:
            ...
            for i in range(50):
                try:
                    ...
                    mock_model = {
                        "name": f"TestWidget{i}",
                        "properties": [{"name": f"prop_{j}", "type": "String"} for j in range(10)],
                        "methods": [{"name": f"method_{k}", "returns": "void"} for k in range(5)]
                    }
