...
class PCodeToSource:
    ...
    def __init__(self) -> None:
        ...
        self.expression_lifter = ExpressionLifter()
        self.reset()
    ...
    def decompile_function(self, instructions: list[PCodeInstruction], name: str) -> str:
        ...
        for inst in instructions:
            if inst.opcode_name == 'STRING' and inst.operand_values:
                ...
                self.expression_lifter.strings[inst.address] = inst.operand_values[0]
        ...
        while i < len(instructions):
            ...
            if inst.opcode_name.startswith('LOAD_'):
                ...
                if expr_end > i:
                    ...
                    statements = self.expression_lifter.analyze_expression_sequence(expr_instructions)
    ...
    def _basic_pattern_recognition(self, instructions: list[PCodeInstruction]) -> list[str]:
        ...
        statements = self.expression_lifter.analyze_expression_sequence(instructions)
        if statements:
            lines.extend(statements)
