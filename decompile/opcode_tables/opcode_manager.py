...
class OpcodeManager:
    ...
    _opcode_cache: Dict[str, Dict[int, Tuple[str, int, Optional[str]]]] = {}
    
    @classmethod
    def get_opcode_table(cls, version: PowerBuilderVersion) -> Dict[int, Tuple[str, int, Optional[str]]]:
    ...
    @classmethod
    def _get_fallback_table(cls, version: PowerBuilderVersion) -> Dict[int, Tuple[str, int, Optional[str]]]:
    ...
    @classmethod
    def _get_minimal_table(cls) -> Dict[int, Tuple[str, int, Optional[str]]]:
