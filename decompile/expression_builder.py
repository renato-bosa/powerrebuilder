...
from model.ast.nodes import (
    Expression, Literal, BinaryExpression, UnaryExpression,
...
class StackValue:
    ...
    source_instruction: Optional[PCodeInstruction] = None
...
class ExpressionBuilder:
    ...
    def process_instruction(self, inst: PCodeInstruction) -> Optional[Expression]:
        ...
        elif opcode == 'ARITHMETIC_OP':
            return self._handle_arithmetic(inst)
            
        # Handle logical operations
        elif opcode == 'LOGICAL_OP':
        ...
        elif opcode in ['CALL_FUNCTION', 'CALL_METHOD']:
    ...
    def _handle_constant(self, inst: PCodeInstruction) -> None:
        ...
        elif opcode == 'CONST_BYTE' or opcode == 'CONST_INT16' or opcode == 'CONST_INT32':
    ...
    def _handle_store(self, inst: PCodeInstruction) -> Optional[Expression]:
        """Handle store operations - these complete expressions."""
        if not self.stack:
            return None
