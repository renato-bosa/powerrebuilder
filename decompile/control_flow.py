...
class ControlBlock:
    ...
    condition_addr: Optional[int] = None
    target_addr: Optional[int] = None  # For jumps
...
class ControlFlowAnalyzer:
    ...
    def __init__(self):
        ...
        self.current_block: Optional[ControlBlock] = None
    ...
    def _identify_control_points(self):
    ...
    def _analyze_function(self, func_block: ControlBlock, start: int, end: int):
    ...
    def _handle_conditional_jump(self, inst: PCodeInstruction, parent: ControlBlock, idx: int):
    ...
    def _handle_unconditional_jump(self, inst: PCodeInstruction, parent: ControlBlock, idx: int):
    ...
    def _extract_jump_target(self, inst: PCodeInstruction) -> Optional[int]:
    ...
    def get_block_at_address(self, addr: int) -> Optional[ControlBlock]:
    ...
    def _get_block_recursive(self, block: ControlBlock, addr: int) -> Optional[ControlBlock]:
