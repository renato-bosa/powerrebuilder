...
from .expression_lifter import ExpressionLifter, Expression
...
class StructuredDecompiler:
    ...
    def __init__(self, version: str = "pb80_0"):
        ...
        self.cf_analyzer = EnhancedControlFlowAnalyzer()
    ...
    def decompile_file(self, input_path: Path, output_path: Optional[Path] = None) -> bool:
...
def decompile_with_structure(input_file: Path, output_file: Optional[Path] = None,
