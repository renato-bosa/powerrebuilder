...
class ControlFlowAnalyzer:
    ...
    def _check_if_pattern(self, blocks: List[ControlBlock], start_idx: int) -> Optional[ControlBlock]:
    ...
    def _check_while_pattern(self, blocks: List[ControlBlock], start_idx: int) -> Optional[ControlBlock]:
    ...
    def _check_for_pattern(self, blocks: List[ControlBlock], start_idx: int) -> Optional[ControlBlock]:
