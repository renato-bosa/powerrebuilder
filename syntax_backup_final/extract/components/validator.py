                            ...
                            self, output_dir: Path, expected_entries: list[str]
                                ...
                                for file_path in extracted_files:
                                    if not self._validate_extracted_file(file_path):
                                        ...
                                        result["statistics"]["corrupted_count"] += 1                                            result["statistics"]["valid_count"] += 1
                                                                                                                                                ...
                                                                                                                                                if marker in content:
                                                                                                                                                    ...
                                                                                                                                                    try:
                                                                                                                                                        ...
                                                                                                                                                        for chunk in iter(lambda: f.read(4096), b""):
                                                                                                                                                            ...
                                                                                                                                                            # Overall status
                                                                                                                                                            if result["valid"]:
                                                                                                                                                                summary_parts.append("Extraction validation PASSED")                                                                                                                                                                    summary_parts.append("Extraction validation FAILED")
