...
def __init__(
    self, name: str, values: dict[str, int], parent_type: str | None = None
    ) -> None:
...
def __init__(
    self, name: str, fields: list[Variable], parent_type: str | None = None
    ) -> None:
...
def parse_type_declaration(
    self, tree: Tree
    ) -> CustomType | EnumeratedType | StructureType:
                    ...
                    name = str(child)
                        ...
                        is_global = True
                            ...
                            if child.data == "from_clause":
                                parent_type = self._extract_parent_type(
                                child)
                                    ...
                                    if is_enumerated:
                                        ...
                                        child)
                                            ...
                                            fields = self._parse_structure_body(
                                            child)
                                            ...
                                            if is_enumerated:
                                                ...
                                                name, enum_values, parent_type)
                                                    ...
                                                    type_obj = StructureType(
                                                    name, fields, parent_type)
                                                    else:
                                                        type_obj = CustomType(
                                                        name, TypeCategory.CUSTOM, parent_type)
                    ...
                    if isinstance(child, Tree) and child.data == "enum_value":
                        ...
                        if name:
                            ...
                            def _parse_enum_value(
                                self, tree: Tree, default_value: int
                                ) -> tuple[str | None, int]:
                                            ...
                                            if i + 1 < len(tree.children):
                                                ...
                                                if isinstance(next_child, Token) and next_child.type == "INT":
                                                    value = int(next_child)
                                                        ...
                                                        isinstance(next_child, Tree) and next_child.data == "expression"
                                                        ):
                                                            ...
                                                            try:
                                                                ...
                                                                if hasattr(self, "_current_enum_values"):
                                                                    ...
                                                                    value=int(value)                                                                        logger.warning(
                                                                        f"Enum expression evaluated to non-numeric value: {value}"
                                                                        )
                                                                        value=NoneException as e:
                                    ...
                                    if field:
                                        ...
                                        if isinstance(child, Token):
                                            if child.type == "IDENTIFIER":
                                                if type_name is None and child.value.lower() in [:
                                                    "integer",
                                                    "string",
                                                    "boolean",
                                                    "long",
                                                                    ...
                                                                    if child.data == "expression":
                                                                        ...
                                                                        try:
                                                                            ...
                                                                            if initial_value is not None:
                                                                                logger.debug(
                                                                                f"Successfully evaluated initial value expression: {initial_value}"
                                                                                )Exception as e:
                                                                                    logger.warning(
                                                                                    ...
                                                                                    if child.data == "visibility_modifier":
                                                                                        for token in child.children:
                                                                                            if isinstance(token, Token):
                                                                                                ...
                                                                                                def register_type(
                                                                                                    self, type_obj: CustomType | EnumeratedType | StructureType
                                                                                                    ) -> None:
