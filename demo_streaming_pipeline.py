...
from src.common.dependency_injection import configure_services, get_container
from src.common.streaming_pipeline import StreamingPipelineCoordinator
from src.common.pipeline_streaming import get_stream_manager
...
def demo_memory_streaming():
    ...
    from src.common.pipeline_streaming import MemoryStream, StreamManager
...
def compare_pipeline_modes():
    ...
    # Compare results
    logger.info("\n--- Comparison ---")
    logger.info("Time saved: %.2f seconds (%.1f%% faster)",
...
def demonstrate_backpressure():
    ...
    from src.common.pipeline_streaming import MemoryStream
...
async def demo_async_streaming():
    ...
    from src.common.pipeline_streaming import AsyncMemoryStream
    import asyncio
