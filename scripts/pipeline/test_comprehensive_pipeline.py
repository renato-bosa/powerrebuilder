...
class PipelineTestRunner:
    ...
    def __init__(self, test_name: str = "pipeline_test"):
        self.test_name = test_name
        self.project_root = Path(__file__).parent.parent.parent
        self.test_output_dir = self.project_root / "output" / f"test_{test_name}_{int(time.time())}"
        self.results = {
            "test_name": test_name,
    ...
    def test_generation(self) -> Dict[str, Any]:
        ...
        cmd = [
            ...
            "python", "-m", "main",
            "generate",
            "--parsed-dir", str(self.test_output_dir / "parsed"),
            "--decompiled-dir", str(self.test_output_dir / "decompiled")
        ]
        ...
        generated_files = {
            ...
            "services": list((self.test_output_dir / "generated").rglob("*service*.py"))
        }
    ...
    def test_full_pipeline(self) -> Dict[str, Any]:
        ...
        cmd = [
            ...
            "python", "-m", "main",
            "all",
            "--pbl-input-dir", str(self.project_root / "input" / "pbd_files"),
            "--base-output-dir", str(full_test_dir),
            "--debug",
            "--enable-byte-recovery"
        ]
    ...
    def run_all_tests(self):
        ...
        for stage_name, stage_data in self.results["stages"].items():
            if isinstance(stage_data, dict) and "success" in stage_data:
                ...
                logger.info(f"{status} {stage_name}: {'PASSED' if stage_data['success'] else 'FAILED'}")
...
def main():
    ...
    parser.add_argument("--name", default="pipeline_test", help="Test name for output directory")
    parser.add_argument("--cleanup", action="store_true", help="Clean up test output after completion")
    parser.add_argument("--quick", action="store_true", help="Run quick test with limited files")
