...
with open("build/delete_list.txt") as f:
    files_to_check = [
...
def check_file_references(filepath):
    ...
    module_parts = module_parts.removeprefix("src.")
...
for filepath in files_to_check:
    ...
    if refs:
        ...
        print("  SAFE - No references found")
...
print("\nResults written to:")
print("  - build/safe_delete_list.txt")
print("  - build/not_safe_to_delete.txt")
