...
from .base.pb_behavioral import PBBehavioralNode
from .base.pb_file import PBCommonFileNode
...
from .ui.ui_elements import Window, Menu
...
class ModelCoordinator:
    ...
    def create_datawindow(self, name: str, sql_source: Optional[str] = None, **kwargs) -> PBDataWindow:
...
def create_datawindow(name: str, sql_source: Optional[str] = None, **kwargs) -> PBDataWindow:
