...
def create_builtin_functions() -> Dict[str, Callable]:
    ...
    return {
        # String functions
        "len": pb_len,
        "lenw": pb_len,  # Wide char version, same as len in Python
        "trim": pb_trim,
        "ltrim": pb_ltrim,
        "rtrim": pb_rtrim,
        "upper": pb_upper,
        ...
        "second": pb_second,
        "dayname": pb_dayname,
        "daynumber": pb_daynumber,
        "daysafter": pb_daysafter,
        "secondsafter": pb_secondsafter,
        "relativedate": pb_relativedate,
        "relativetime": pb_relativetime,
        
        # Type checking/conversion
        "isnull": pb_isnull,
        "isvalid": pb_isvalid,
        "isnumber": pb_isnumber,
        "isdate": pb_isdate,
        "istime": pb_istime,
        "string": pb_string,
        "real": pb_real,
        ...
        # Array functions
        "upperbound": pb_upperbound,
        "lowerbound": pb_lowerbound,
...
def pb_round(value: Union[int, float], decimals: int = 0) -> Union[int, float]:
...
def pb_truncate(value: Union[int, float], decimals: int = 0) -> Union[int, float]:
...
def pb_mod(a: Union[int, float], b: Union[int, float]) -> Union[int, float]:
    """Modulo operation."""
    if b == 0:
...
def pb_sign(value: Union[int, float]) -> int:
...
def pb_year(date: Union[datetime.date, datetime.datetime]) -> int:
...
def pb_month(date: Union[datetime.date, datetime.datetime]) -> int:
...
def pb_day(date: Union[datetime.date, datetime.datetime]) -> int:
...
def pb_hour(time: Union[datetime.time, datetime.datetime]) -> int:
...
def pb_minute(time: Union[datetime.time, datetime.datetime]) -> int:
...
def pb_second(time: Union[datetime.time, datetime.datetime]) -> int:
...
def pb_dayname(date: Union[datetime.date, datetime.datetime]) -> str:
...
def pb_daynumber(date: Union[datetime.date, datetime.datetime]) -> int:
...
def pb_daysafter(date1: Union[datetime.date, datetime.datetime], 
...
def pb_secondsafter(time1: Union[datetime.time, datetime.datetime],
                    time2: Union[datetime.time, datetime.datetime]) -> int:
...
def pb_relativedate(date: Union[datetime.date, datetime.datetime], days: int) -> datetime.date:
    """Add days to date."""
    if date is None:
        return datetime.date.today()
...
def pb_relativetime(time: Union[datetime.time, datetime.datetime], seconds: int) -> datetime.time:
    """Add seconds to time."""
    if time is None:
...
def pb_date(value: Union[str, datetime.datetime]) -> datetime.date:
    """Convert to date."""
    if value is None:
        return datetime.date.today()
...
def pb_time(value: Union[str, datetime.datetime]) -> datetime.time:
    """Convert to time."""
    if value is None:
