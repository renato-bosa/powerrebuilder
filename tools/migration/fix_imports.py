...
def fix_imports_in_file(file_path: Path) -> bool:
    ...
    old_import_patterns = [
        ...
        (r'import (common|extract|parse|decompile|model|generate)\.', r'import src.\1.'),
        (r'from (common|extract|parse|decompile|model|generate) import', r'from src.\1 import'),
        (r'import (common|extract|parse|decompile|model|generate)(\s|$)', r'import src.\1\2'),
        
        # Fix imports that were already partially corrected
        (r'from src\.(common|extract|parse|decompile|model|generate)\.', r'from src.\1.'),
        
        # Fix specific problematic imports
        (r'from decompile\.constants import', r'from src.decompile.opcodes import'),
        (r'from src\.decompile\.constants import', r'from src.decompile.pcode.opcodes.definitions import'),
        (r'from extract\.pbd\.extractors\.extractor import', r'from src.extract.pbd.extractors.base import'),
    ]
...
def main():
    ...
    print(f"Fixing imports in: {tools_dir}")
    ...
    for file_path in python_files:
        ...
        if file_path.name == "fix_imports.py" or "migration" in str(file_path):
            continue
