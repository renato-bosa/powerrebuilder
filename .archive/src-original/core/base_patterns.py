...
class ValidationMixin:
    ...
    def validate_path(self, path: PathLike, must_exist: bool = True, must_be_file: bool = False) -> bool:
    ...
    def validate_input(self, data: Any, rules: Optional[List[Callable[[Any], bool]]] = None) -> bool:
    ...
    def validate_output(self, data: Any, expected_type: Optional[type] = None) -> bool:
        ...
        if expected_type and not isinstance(data, expected_type):
            raise ValueError(f"Output data has wrong type. Expected {expected_type}, got {type(data)}")
...
class BinaryOperationsMixin:
    ...
    def read_struct_from_bytes(self, data: bytes, offset: int, format_str: str) -> tuple:
    ...
    def write_binary_file(self, path: PathLike, data: bytes, create_dirs: bool = True) -> None:
...
class ProgressReportingMixin:
    ...
    def __init__(self, *args, progress_reporter: Optional[IProgressReporter] = None, **kwargs):
        super().__init__(*args, **kwargs)
        self._progress_reporter = progress_reporter
        self._active_tasks: Dict[str, bool] = {}
        
    def start_progress(self, task_id: str, description: str, total: Optional[int] = None) -> None:
    ...
    @contextmanager
    def progress_context(self, task_id: str, description: str, total: Optional[int] = None):
