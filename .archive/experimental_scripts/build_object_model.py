    ...
    def _process_metadata_file(self, json_file: Path) -> Optional[PBModule]:
        ...
        try:
            ...
            for obj in metadata.get('objects', []):
                ...
                elif obj_type in ['commandbutton', 'datawindow_control', 'checkbox',
                                 'listbox', 'statictext', 'groupbox']:
...
def main():
    ...
    print(f"Total Business Objects: {report['system_overview']['total_business_objects']}")
