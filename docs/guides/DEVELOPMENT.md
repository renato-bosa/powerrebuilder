# SIME Finch Development Guide

This guide consolidates all active development documentation for the SIME Finch PowerBuilder reverse engineering project.
...
4. [Future Architecture Plans](#future-architecture-plans)
...
from parse.utils.grammar_loader import GRAMMAR_DIR
print(GRAMMAR_DIR)  # Should point to parse/grammar/
```
