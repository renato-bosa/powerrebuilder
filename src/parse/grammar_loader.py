...
from ...core.constants import GRAMMAR_DIR
from ...core.exceptions import GrammarLoadError
...
def load_grammar(
    ...
    *,
    ...
    try:
        ...
        with Path(grammar_file).open(encoding="utf-8") as f:
