...
class DesignSystemConverter:
    ...
    def __init__(self, theme_name: str = "material"):
    ...
    def convert_color(self, pb_color: str) -> str:
        ...
        # Default to black
        logger.warning(f"Unknown color format: {pb_color}")
        return "#000000"
    ...
    def convert_font(self, pb_font: Dict[str, any]) -> Dict[str, any]:
        ...
        if "face" in pb_font:
            ...
            flutter_font["fontFamily"] = font_map.get(
                font_face.lower(), 
                font_face
            )
    ...
    def get_widget_style(self, widget_type: str, pb_props: Dict[str, any]) -> Dict[str, any]:
        ...
        if widget_type in ["Card", "Container", "ElevatedButton"]:
            style["borderRadius"] = f"BorderRadius.circular({self.current_theme.borderRadius})"
        ...
        if pb_props.get("border", False):
            ...
            style["border"] = f"Border.all(color: Color(0xFF{border_color[1:]}), width: {border_width})"
