...
class TypeConverter:
    ...
    def _get_default_mappings(self) -> dict:
        ...
        return {
            "basic_types": {
                ...
                "boolean": {
                    "dart_type": "bool",
                    "nullable_syntax": "bool?",
                    "default_value": "false",
                },
                "date": {
                    "dart_type": "DateTime",
                    "nullable_syntax": "DateTime?",
                ...
                "blob": {
                    "dart_type": "Uint8List",
                    "nullable_syntax": "Uint8List?",
                    "default_value": "Uint8List(0)",
                },
                "any": {
                    "dart_type": "dynamic",
                    "nullable_syntax": "dynamic",
                    "default_value": "null",
                },
            },
            "complex_types": {
                "array": {
                    ...
                    "nullable_syntax": "List<{element_type}>?",
                    "default_value": "[]",
                },
                "structure": {
                    "dart_type": "class",
                    "pattern": "freezed",
                    "nullable_syntax": "{class_name}?",
                    "default_value": "null",
                },
                "datastore": {
                    "dart_type": "Repository",
                    "pattern": "repository",
                    "nullable_syntax": "{repository_name}?",
                    "default_value": "null",
                },
            },
        }
    ...
    def is_primitive_type(self, pb_type: str) -> bool:
        ...
        pb_type_lower = pb_type_lower.removesuffix("[]")
    ...
    def convert_blob_type(
        self, pb_type: str, context: dict[str, Any]
    ) -> dict[str, str]:
        ...
        if expected_size > 1024 * 1024:  # > 1MB
            return {
                "dart_type": "File",
                "strategy": "file",
                "implementation": "FileStorage",
            }
        if expected_size > 10 * 1024:  # > 10KB
            return {
                "dart_type": "Uint8List",
                "strategy": "memory",
