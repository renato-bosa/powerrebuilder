...
class TypeConverter:
    ...
    def __init__(self, target_language: str = "dart") -> None:
    ...
    def get_import_for_type(self, type_str: str) -> str | None:
        ...
        if self.target_language == "dart":
            ...
            if "DataStore" in type_str or "DataWindow" in type_str:
                return "import 'package:powerbuilder_core/powerbuilder_core.dart';"
        elif self.target_language == "python":
            if "datetime" in type_str:
                return "from datetime import datetime"
            if "Optional" in type_str or "List" in type_str or "Dict" in type_str:
