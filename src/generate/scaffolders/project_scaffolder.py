...
from src.contracts.generators import IProjectScaffolder
    ...
    def create_boilerplate_files(
        ...
        for module in modules:
            ...
            if 'model' in module:
                ...
                boilerplate.update(self._create_controller_boilerplate(module_dir, module))
            else:
