...
# ============================================================================
# Text extraction utilities (from text.py)
# ============================================================================


def extract_ascii_strings(data: bytes) -> str:
...
def extract_pb_export_section(data: bytes) -> str | None:
...
def extract_pb_patterns(data: bytes) -> str:
