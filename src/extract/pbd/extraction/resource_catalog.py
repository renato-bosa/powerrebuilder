...
class ResourceCatalog:
    ...
    def add_image_resource(self, source_object: str, resource_info: dict[str, Any]) -> None:
        ...
        logger.debug(f"Added image resource from {source_object}: {resource_info.get('format', 'unknown')}")
    ...
    def add_string_resource(self, source_object: str, string_value: str) -> None:
        ...
        logger.debug(f"Added string resource from {source_object}: {len(string_value)} chars")

    def add_binary_resource(self, source_object: str, resource_type: str, resource_info: dict[str, Any]) -> None:
        ...
        logger.debug(f"Added binary resource from {source_object}: {resource_type}")
    ...
    def save_catalog(self, output_path: Path) -> None:
        ...
        try:
            ...
            logger.info(f"Saved resource catalog to {catalog_file}")
        except Exception as e:
            logger.error(f"Failed to save resource catalog: {e}")