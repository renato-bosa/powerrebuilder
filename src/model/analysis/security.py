...
r'pwd\s*=\s*["\']([^"\']+)["\']',
    ...
    def analyze(
        self,
        ast_nodes: list[PBNode],
        source_file: str | None = None) -> SecurityAnalysis:
    ...
    """
        ...
        sql_injections=[
        self._format_issue(issue) for issue in self.sql_injections], hardcoded_credentials=[
        self._format_issue(issue) for issue in self.hardcoded_credentials], insecure_functions=[
    ...
    """
        ...
        # First 200 chars
        "type": "potential_sql_injection", "severity": "high", "description": "SQL query uses string concatenation with variables", "code": sql_text[:200],
        ...
        if any(keyword in sql_text.lower():
        for keyword in self.SQL_DYNAMIC_KEYWORDS):
        self.sql_injections.append({"type": "dynamic_sql",
        "severity": "medium",
    ...
    """
        ...
        self.insecure_functions.append({"type": "insecure_function",
