...
class ProgressMetrics:
    ...
    def completion_percentage(self) -> float:
        ...
        return (self.items_processed / self.items_total * 100) if self.items_total > 0 else 0
...
class EnhancedProgressReporter:
    ...
    def _create_performance_panel(self) -> Panel:
        ...
        eta_formatted = f"{eta_seconds // 60:.0f}m {eta_seconds % 60:.0f}s" if eta_seconds > 60 else f"{eta_seconds:.1f}s"
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "quality": {
                ...
                "success_rate": (self.metrics.items_processed - self.metrics.errors_count) / self.metrics.items_processed * 100 if self.metrics.items_processed > 0 else 0,
            },
            "system": {
