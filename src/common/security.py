...
class PathValidator:
    ...
    @classmethod
    def validate_path(cls, path: Union[str, Path], base_dir: Union[str, Path]) -> Path:
        """
    ...
    def validate_filename(cls, filename: str) -> str:
        """
        Validate a filename is safe for use.
...
def safe_create_directory(path: Union[str, Path], base_dir: Union[str, Path]) -> Path:
    """
