...
from src.model.ast.nodes.literals import BooleanLiteral as PBBooleanLiteral
from src.model.ast.nodes.literals import NullLiteral as PBNullLiteral
...
class ExpressionOptimizer:
    ...
    def _is_literal(self, expr: Expression) -> bool:
        ...
        return isinstance(
            expr, PBNumberLiteral | PBStringLiteral | PBBooleanLiteral | PBNullLiteral
        )
    ...
    def _fold_unary_constants(
        self, operator: str, operand: Expression
    ) -> Expression | None:
        ...
        if operator == "NOT" and isinstance(operand, PBBooleanLiteral):
    ...
    def _fold_power_constants(
        self, base: Expression, exponent: Expression
    ) -> Expression | None:
