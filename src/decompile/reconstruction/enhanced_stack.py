...
class StackValue:
    ...
    source_offset: Optional[int] = None  # P-code offset where value originated
...
class EnhancedStackManager:
    ...
    def create_snapshot(self, offset: int, label: str = "") -> StackSnapshot:
        ...
        logger.debug("Created stack snapshot at offset 0x%04x: %d items", offset, len(self.stack))
        return snapshot
    ...
    def pop(self, expected_type: Optional[StackValueType] = None) -> Optional[StackValue]:
        ...
        # Type checking
        if expected_type and value.value_type != expected_type and value.value_type != StackValueType.UNKNOWN:
            logger.warning(
    ...
    def _recover_missing_value(self, expected_type: Optional[StackValueType] = None) -> StackValue:
    ...
    def _generate_typed_placeholder(self, value_type: StackValueType) -> StackValue:
        ...
        placeholders = {
            ...
            StackValueType.DATETIME: ("DateTime(1900-01-01 00:00:00)", "DateTime(1900-01-01 00:00:00)"),
        ...
        return StackValue(
            ...
            metadata={"recovery_reason": "stack_underflow", "recovery_count": self.recovery_count},
        )
    ...
    def pop_multiple(self, count: int, expected_types: Optional[list[StackValueType]] = None) -> list[StackValue]:
