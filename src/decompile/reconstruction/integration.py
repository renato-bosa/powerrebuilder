...
from .enhanced_reconstructor import EnhancedExpressionReconstructor, ReconstructionMode, ReconstructionResult
from .output_formatter import PowerBuilderOutputFormatter, OutputStyle
...
class IntegratedReconstructor:
    ...
    def _fallback_to_legacy(self, block: ControlBlock) -> None:
        ...
        try:
            ...
            block.statements = [f"// ERROR: Both enhanced and legacy reconstruction failed - {e}"]
