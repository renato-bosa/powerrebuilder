...
PB_BASIC_TYPES: set[str] = {
    "integer", "int", "long", "uint", "ulong",
    "string", "char", "character",
    "boolean", "bool",
    "date", "datetime", "time",
    "decimal", "dec", "real", "double",
    "blob",
    "any",
}
...
PB_CONTROL_TYPES: set[str] = {
    "commandbutton", "datawindow", "edit", "statictext",
    "checkbox", "radiobutton", "dropdownlistbox", "picturebutton",
    "tab", "groupbox", "treeview", "listview", "richtextedit",
    "graph", "ole", "vscrollbar", "hscrollbar", "picture", "mdiclient",
}

# PowerBuilder event types
PB_EVENT_TYPES: set[str] = {
    "clicked", "doubleclicked", "itemchanged", "itererror",
    "itemfocuschanged", "rbuttondown", "rowfocuschanged",
    "rowfocuschanging", "create", "destroy", "buttonclicked",
    "buttonclicking", "getfocus", "losefocus", "modified",
}

# PowerBuilder keywords
PB_KEYWORDS: set[str] = {
    "if", "then", "else", "elseif", "end", "case", "choose",
    "do", "loop", "while", "until", "for", "next", "step",
    "continue", "exit", "return", "try", "catch", "finally", "throw",
    "this", "super", "goto", "gosub", "call", "post", "trigger",
    "create", "destroy", "open", "close", "function", "subroutine",
    "event", "private", "public", "protected", "global", "shared",
    "on", "type", "constant", "variables", "forward", "from", "to",
    "ref", "autoinstantiate", "within", "of", "parent", "using",
    "dynamic", "indirect", "not", "and", "or", "xor", "true", "false",
}
...
SQL_KEYWORDS: set[str] = {
    ...
    "having", "order", "asc", "desc", "distinct", "union", "all",
    "into", "values", "set", "null", "is", "not", "like", "in",
    "between", "exists", "create", "alter", "drop", "table", "view",
    "index", "procedure", "function", "constraint", "primary", "key",
    "foreign", "references", "default", "check", "unique", "identity",
}
