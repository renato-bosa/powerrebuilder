...
class PowerBuilderFamixModelGenerator:
    ...
    def define_classes(self) -> None:
        ...
        self.state.classes["GraphicComponent"] = self.state.builder.new_class(
            "GraphicComponent"
        )
        ...
        self.state.classes["SharedVariable"] = self.state.builder.new_class(
            "SharedVariable"
        )
        self.state.classes["LocalVariable"] = self.state.builder.new_class(
            "LocalVariable"
        )
        self.state.classes["GlobalVariable"] = self.state.builder.new_class(
            "GlobalVariable"
        )
        self.state.classes["InstanceVariable"] = self.state.builder.new_class(
            "InstanceVariable"
        )
        ...
        self.state.classes["FunctionReturn"] = self.state.builder.new_class(
            "FunctionReturn"
        )
        ...
        self.state.classes["GlobalFunction"] = self.state.builder.new_class(
            "GlobalFunction"
        )
        ...
        self.state.classes["BehaviorSignature"] = self.state.builder.new_class(
            "BehaviorSignature"
        )
        ...
        self.state.classes["VariableAccess"] = self.state.builder.new_class(
            "VariableAccess"
        )
    ...
    def define_traits(self) -> None:
        ...
        self.state.traits["PBTWithMethods"] = self.state.builder.new_trait(
            "PBTWithMethods"
        )
    ...
    def define_hierarchy(self) -> None:
        ...
        self.state.classes["GraphicComponent"].inherits_from(
            ["TSourceEntity", "TWithAttributes", "Behavioral"]
        )

        # Behavioral elements
        self.state.classes["Event"].inherits_from(
            ["Behavioral", "TMethod", "TInvocable"]
        )
        ...
        self.state.classes["Trigger"].inherits_from(
            ["TWithAttributes", "Behavioral", "TMethod"]
        )
        self.state.classes["Trigger"].uses_trait("PBTNamed", exclude=["mooseNameOn"])

        self.state.classes["SubRoutine"].inherits_from(
            ["Behavioral", "TMethod", "TInvocable"]
        )
        self.state.classes["SubRoutine"].uses_trait("PBTNamed", exclude=["mooseNameOn"])

        # Variables and attributes
        self.state.classes["Variable"].inherits_from(
            ["TSourceEntity", "TNamedEntity", "TWithTypes", "TAccessible"]
        )
        self.state.classes["Parameter"].inherits_from(
            ["TSourceEntity", "TNamedEntity", "TWithTypes", "TAccessible"]
        )
        ...
        self.state.classes["MajorObject"].uses_trait(
            "PBTWithMethods", exclude=["numberOfLinesOfCode"]
        )

        self.state.classes["UserObject"].inherits_from(
            ["MajorObject", "AbstractType", "TWithInvocations"]
        )
        self.state.classes["Window"].inherits_from(["MajorObject", "TWithInvocations"])
        self.state.classes["DataWindow"].inherits_from(
            ["MajorObject", "TWithInvocations"]
        )
        self.state.classes["Structure"].inherits_from(["MajorObject"])
        self.state.classes["GlobalFunction"].inherits_from(
            ["MajorObject", "TWithInvocations", "AbstractType"]
        )
        ...
        # Types
        self.state.traits["AbstractType"].uses_trait(
            "PBTNamed", exclude=["mooseNameOn"]
        )
        ...
        self.state.classes["Invocation"].inherits_from(
            ["TInvocation", "THasSignature", "TSourceEntity"]
        )
    ...
    def define_properties(self) -> None:
        ...
        self.state.classes["FunctionReturn"].add_property(
            "doesBelongToSingleLineIfStatement", "Boolean"
        )
