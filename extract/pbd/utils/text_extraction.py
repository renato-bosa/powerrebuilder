...
def binary_to_readable_format(file_path: Path, output_path: Optional[Path] = None) -> Optional[str]:
    ...
    try:
        ...
        for pattern in pb_patterns:
            ...
            for idx in indices:
                ...
                if line_match:
                    pattern_matches.append(line_match.group().decode('latin1', errors='replace'))
