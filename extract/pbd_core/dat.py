...
from extract.pbd_io.utils import bin2int, retrieve_bytes_from_file
...
def extract_data_from_entry(
    ...
    while current_block_offset != 0:
        ...
        if potential_header_bytes.startswith(dat_sig_unicode):
            ...
            next_block_offset_in_header = bin2int(potential_header_bytes[DAT_NEXT_BLOCK_OFFSET_FIELD_OFFSET_UNICODE : DAT_NEXT_BLOCK_OFFSET_FIELD_OFFSET_UNICODE + DAT_NEXT_BLOCK_OFFSET_FIELD_LEN])
            data_len_in_header = bin2int(potential_header_bytes[DAT_DATA_LEN_FIELD_OFFSET_UNICODE : DAT_DATA_LEN_FIELD_OFFSET_UNICODE + DAT_DATA_LEN_FIELD_LEN])
            ...
            next_block_offset_in_header = bin2int(potential_header_bytes[DAT_NEXT_BLOCK_OFFSET_FIELD_OFFSET_ASCII : DAT_NEXT_BLOCK_OFFSET_FIELD_OFFSET_ASCII + DAT_NEXT_BLOCK_OFFSET_FIELD_LEN])
            data_len_in_header = bin2int(potential_header_bytes[DAT_DATA_LEN_FIELD_OFFSET_ASCII : DAT_DATA_LEN_FIELD_OFFSET_ASCII + DAT_DATA_LEN_FIELD_LEN])
        else:
            logger.error(
