                                    ...
                                    block.statements.append(statement)
                                        ...
                                        if inst.opcode_name == "RETURN" and isinstance(:
                                            e, IndexError):
                                                ...
                                                "return  // Stack was empty")                                                    block.statements.append(
                                                                                                                                                            ...
                                                                                                                                                            if opcode == "PUSH_CONST_STRING" and operands:
                                                                                                                                                                ...
                                                                                                                                                                if opcode == "PUSH_CONST_BOOL" and operands:
                                                                                                                                                                    ...
                                                                                                                                                                    if opcode == "PUSH_THIS":
                                                                                                                                                                        ...
                                                                                                                                                                        if opcode == "PUSH_NULL":
                                                                                                                                                                            self.stack.append(StackValue("null", "null"))                                                                                                                                                                                # Generic push
                                                                                                                                                                                ...
                                                                                                                                                                                if len(self.stack) < 2:
                                                                                                                                                                                    ...
                                                                                                                                                                                    if len(self.stack) == 1:
                                                                                                                                                                                        ...
                                                                                                                                                                                        "Stack underflow for %s, using 0 for right operand", opcode
                                                                                                                                                                                            ...
                                                                                                                                                                                            return f"// ERROR: Stack underflow for {opcode}"                                                                                                                                                                                                right = self.stack.pop()
                                                                                                                                                                                                left = self.stack.pop()
                                                                                                                                                                                                ...
                                                                                                                                                                                                if len(self.stack) < 2:
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    if len(self.stack) == 1:
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        "Stack underflow for %s, using 0 for right operand", opcode
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            return f"// ERROR: Stack underflow for {opcode} - assuming TRUE"                                                                                                                                                                                                                right = self.stack.pop()
                                                                                                                                                                                                                left = self.stack.pop()
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                if opcode == "NOT":
                                                                                                                                                                                                                    if not self.stack:
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        self.stack.append(StackValue(result, "boolean"))                                                                                                                                                                                                                            if len(self.stack) < 2:
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        if not self.stack:
                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                            if operands:
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                if operands:
                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                    if len(operands) > 1:
                                                                                                                                                                                                                                                        arg_count = operands[1]                                                                                                                                                                                                                                                            # Try to infer from opcode name (e.g., CALL_FUNC_2 has 2 args)
                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                            if parts and parts[-1].isdigit():
                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                for _ in range(arg_count):
                                                                                                                                                                                                                                                                    if self.stack:
                                                                                                                                                                                                                                                                        arg = self.stack.pop()
                                                                                                                                                                                                                                                                        args.insert(0, arg.expression)  # Insert at beginning to maintain order                                                                                                                                                                                                                                                                            args.insert(0, "/* missing arg */")
                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                            if self.stack and len(self.stack) > 0 and "." in str(self.stack[-1].expression):
                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                if obj_ref.expression.endswith(f".{method_name}"):
                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                    self.stack.pop()
                                                                                                                                                                                                                                                                                    method_call = f"{obj_ref.expression}"                                                                                                                                                                                                                                                                                        method_call = method_name                                                                                                                                                                                                                                                                                            method_call = method_name
                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                        if self.stack:
                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                            if not self.stack:
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                if "LONG" in opcode:
                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                    if "DOUBLE" in opcode or "REAL" in opcode:
                                                                                                                                                                                                                                                                                                                        target_type = "double"
                                                                                                                                                                                                                                                                                                                        converted_expr = f"Double({value.expression})"

                                                                                                                                                                                                                                                                                                                        if "DECIMAL" in opcode or "DEC" in opcode:
                                                                                                                                                                                                                                                                                                                            target_type = "decimal"
                                                                                                                                                                                                                                                                                                                            converted_expr = f"Dec({value.expression})"

                                                                                                                                                                                                                                                                                                                            if "STRING" in opcode or "STR" in opcode:
                                                                                                                                                                                                                                                                                                                                target_type = "string"
                                                                                                                                                                                                                                                                                                                                converted_expr = f"String({value.expression})"

                                                                                                                                                                                                                                                                                                                                if "BOOL" in opcode or "BOOLEAN" in opcode:
                                                                                                                                                                                                                                                                                                                                    target_type = "boolean"
                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                    if "DATE" in opcode:
                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                        if "TIME" in opcode:
                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                            if "DATETIME" in opcode or "TIMESTAMP" in opcode:
                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                if "CHAR" in opcode:
                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                    if "ANY" in opcode:
                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                        converted_expr = value.expression                                                                                                                                                                                                                                                                                                                                                            # Generic cast if we can't determine the type
