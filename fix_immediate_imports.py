...
'''
    ...
    print(f"Fixed {ast_init}")


def fix_missing_node_classes():
...
''')
    ...
    if additions:
        ...
        print(f"Added missing classes to {literals_file}")
...
def main():
    """Run all fixes."""
    print("Fixing immediate import issues...")
